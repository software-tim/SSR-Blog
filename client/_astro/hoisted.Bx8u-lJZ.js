      ...
      <article class="border-b border-gray-100 pb-3 last:border-b-0">
        ...
        ${n.length>0?`
          <div class="mt-2 flex flex-wrap gap-1">
            ${n.slice(0,3).map(m=>`<span class="inline-flex items-center px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 rounded">${m}</span>`).join("")}
          </div>
        `:""}
